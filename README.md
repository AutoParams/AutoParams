...
```groovy
testImplementation 'io.github.autoparams:autoparams:4.5.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-mockito:4.3.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-lombok:4.3.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-kotlin:4.3.0'
```
