...
```groovy
testImplementation 'io.github.autoparams:autoparams:4.2.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-mockito:4.2.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-lombok:4.2.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-kotlin:4.2.0'
```
