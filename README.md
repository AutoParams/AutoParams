...
```groovy
testImplementation 'io.github.autoparams:autoparams:4.1.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-mockito:4.1.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-lombok:4.1.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-kotlin:4.1.0'
```
