...
```groovy
testImplementation 'io.github.autoparams:autoparams-spring:11.3.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-mockito:11.3.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-lombok:11.3.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-kotlin:11.3.0'
```
