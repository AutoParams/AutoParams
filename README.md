...
```groovy
testImplementation 'io.github.autoparams:autoparams:2.0.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-mockito:2.0.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-lombok:2.0.0'
```
