...
```groovy
testImplementation 'io.github.autoparams:autoparams:2.1.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-mockito:2.1.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-lombok:2.1.0'
```
