...
```groovy
testImplementation 'io.github.autoparams:autoparams:8.1.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-mockito:8.1.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-lombok:8.1.0'
```
...
```groovy
testImplementation 'io.github.autoparams:autoparams-kotlin:8.1.0'
```
