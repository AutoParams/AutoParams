...
public final class ObjectContainer {
     ...
     * the value is null, a distinct container is created, different from EMPTY.
     *
     ...
     *             {@code ObjectContainer} if this is empty
     ...
     * {@code ObjectContainer} wrapping the result. If this container is
     * {@code EMPTY}, returns itself.
     *
     * @param processor a function to process the contained value
     * @return a new {@code ObjectContainer} with the processed value, or
     * {@code EMPTY} if this is empty
     */
