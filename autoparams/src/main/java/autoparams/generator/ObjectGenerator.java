 ...
 * </p>
 * <p>
 * This interface also extends {@link autoparams.customization.Customizer},
...
public interface ObjectGenerator extends Customizer {
     ...
     * <p>
     * This instance delegates to {@link DefaultObjectGenerator} and can be used
     * wherever a standard object generator is required.
     * </p>
     */
    ObjectGenerator DEFAULT = new DefaultObjectGenerator();

    /**
     * Generates an {@link ObjectContainer} for the given {@link Type} and
