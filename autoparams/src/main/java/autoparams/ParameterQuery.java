...
import autoparams.internal.reflect.Parameters;
...
public final class ParameterQuery implements ObjectQuery {
     ...
     * resolve it using the {@link java.beans.ConstructorProperties} annotation if
     * available.
     * </p>
     *
     * @return an {@link Optional} with the parameter name, or empty if not
     *         available
     * @see java.beans.ConstructorProperties
     * @see #getRequiredParameterName()
     */
    public Optional<String> getParameterName() {
        return Parameters.getParameterName(parameter, index);
    }
    ...
    public String getRequiredParameterName() {
        return Parameters.getRequiredParameterName(parameter, index);
    }
