...
/**
 * Tests for ParameterQuery toLog method when inferring property names from setter
 * methods.
 *
 * <p>This addresses issue #318: @LogResolution이 setter 매개변수 이름이 없을 때
 * 메서드 이름을 통해 속성 이름을 유추
 *
...
public class SpecsForParameterQuerySetterInference {
    ...
    @Test
    void toLog_infersPropertyFromSetter_whenParamIsSynthetic()
        throws Exception {
        ...
        // Even if parameter name is "arg0" (synthetic),
        // it should infer "name" from "setName".
        assertThat(actual).isEqualTo("String name");
    }

    @Test
    void toLog_infersPropertyFromSetter_whenMultiWordSetter()
        throws Exception {
    ...
    @Test
    void toLog_infersPropertyFromSetter_whenIntegerType()
        throws Exception {
    ...
    @Test
    void toLog_returnsParamAsIs_whenNotSetter()
        throws Exception {
        ...
        // Since this is not a setter method, it should keep the synthetic
        // parameter name (e.g., "arg0").
        assertThat(actual).isEqualTo("String arg0");
    }

    @Test
    void toLog_infersPropertyFromSetter_whenSingleUppercase()
        throws Exception {
    ...
    @Test
    void toLog_infersPropertyFromSetter_whenAcronym()
        throws Exception {
    ...
    @Test
    void toLog_doesNotInferProperty_whenInvalidSetterName()
        throws Exception {
    ...
    @Test
    void toLog_doesNotInferProperty_whenMultipleParams()
        throws Exception {

        Method multiParamMethod =
            InvalidSetterUser.class.getMethod("setAge", String.class, String.class);
