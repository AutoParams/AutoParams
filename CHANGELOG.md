...
### Fixed
- Fixed `InstancePropertyWriter` to invoke inherited chaining set methods on subclass instances

### Changed
- Improved `LogResolution` to infer property name from setter method
